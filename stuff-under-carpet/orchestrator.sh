...
#python3 result-compiler.py new-tests/240625/2a_Hurink_sdata/ls/lawrence/ 2a_Hurink_sdata-V2ls lawrence
python3 result-compiler.py new-tests/240625/2a_Hurink_sdata/llm/ 2a_Hurink_sdata-V2llm lawrence
python3 result-compiler.py new-tests/240625/2a_Hurink_sdata/llm-ls/ 2a_Hurink_sdata-V2llmls lawrence

python3 result-compiler.py new-tests/240625/6_Fattahi/llm/ 6_Fattahi-V2llm fattahi
python3 result-compiler.py new-tests/240625/6_Fattahi/llm-ls/ 6_Fattahi-V2llmls fattahi

python3 result-compiler.py new-tests/240625/1_Brandimarte/llm/ 1_Brandimarte-V2llm brandimarte
python3 result-compiler.py new-tests/240625/1_Brandimarte/llm-ls/ 1_Brandimarte-V2llmls brandimarte

python3 result-compiler.py new-tests/240625/2d_Hurink_vdata/llm/ 2d_Hurink_vdata-V2llm lawrence
python3 result-compiler.py new-tests/240625/2d_Hurink_vdata/llm-ls/ 2d_Hurink_vdata-V2llmls lawrence

python3 result-compiler.py new-tests/240625/3_DPpaulli/llm/ 3_DPpaulli-V2llm paulli
python3 result-compiler.py new-tests/240625/3_DPpaulli/llm-ls/ 3_DPpaulli-V2llmls paulli
